...
const Modal = ({ children, isOpen, onClose, title }) => {
    ...
    return (
        <div className='fixed top-0 right-0 z-50 flex justify-center items-center w-full h-[calc(100%-1rem)] max-h-full overflow-y-auto overflow-x-hidden bg-black bg-opacity-50'>
            <div className='relative p-4 w-full max-w-2xl h-full'>
                <div className='relative bg-white rounded-lg shadow-sm dark:bg-gray-700'>
                    ...
                    <div className='flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600 border-gray-200'>
                        <h3 className='text-xl font-medium dark:text-white text-gray-900'>{title}</h3>
                        <button
                            type='button'
